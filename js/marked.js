...
(function (global, factory) {
  ...
  function () {
    ...
    _proto.code = function code(_code, infostring, escaped) {
      ...
      var preCls = this.options.preCls ? 'class=' + this.options.preCls : '';

      if (!lang) {
        return '<pre ' + preCls + '><code>' + (escaped ? _code : escape$2(_code, true)) + '</code></pre>';
      }

      return '<pre ' + preCls + '><code class="' + this.options.langPrefix + escape$2(lang, true) + '">' + (escaped ? _code : escape$2(_code, true)) + '</code></pre>\n';
    };
